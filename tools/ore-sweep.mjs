...
buildSync({
  ...
  platform: 'node',
  format: 'esm',
  outfile: 'node_modules/.cache/lab/ore-sweep.mjs',
  logLevel: 'warning',
});
const r = spawnSync(process.execPath, ['node_modules/.cache/lab/ore-sweep.mjs', ...process.argv.slice(2)], { stdio: 'inherit' });
