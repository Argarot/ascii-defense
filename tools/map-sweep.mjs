...
buildSync({
  ...
  platform: 'node',
  format: 'esm',
  outfile: 'node_modules/.cache/lab/map-sweep.mjs',
  logLevel: 'warning',
});
const r = spawnSync(process.execPath, ['node_modules/.cache/lab/map-sweep.mjs', ...process.argv.slice(2)], { stdio: 'inherit' });
