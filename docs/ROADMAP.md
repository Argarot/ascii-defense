...
| 15 | **Map variance — the big one** *(rescoped larger at Daniil's request)* | 2.17 carve v3 (edge partitions, multi-segment slots — makes two-turn tiles real), 2.15 generated tile variants incl. directional shapes, 2.9 boon ground, threat-level knob bundles as data | Two seeds read as genuinely different maps; a minted two-turn tile appears in a generated map; a boon cell buffs a tower through the full stack |
