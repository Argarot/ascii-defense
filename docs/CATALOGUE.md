...
| **Loadbearing** | loadbearing | passive | epic | reach |  |  | Towers touching the Core block get half again their range. | coreAdjacentRangeMul 1.5 | same | same | Towers touching the Core block get double range. [coreAdjacentRangeMul 2] |
...
| **Kindling** | kindling | passive | rare | energy damage |  |  | A burning body that dies passes its burn to everything within a cell and a half. | deathSpreadBurn true | same | same | none |
| **Salvage Rights** | salvage_rights | passive | common | economy |  |  | Sold towers refund 85% instead of 70%. | sellRefundBonus 0.15 | Sold towers refund in full. [sellRefundBonus 0.3] | Sold towers refund in full. [sellRefundBonus 0.3] | none |
...
| **Wide Net** | wide_net | passive | common | kinetic | yes |  | Every shot passes into one more body. | pierceAdd 1 | Every shot passes into two more bodies. [pierceAdd 2] | Every shot passes into three more bodies. [pierceAdd 3] | none |
| **Grounding Rod** | grounding_rod | passive | common | energy | yes |  | Every arc jumps to one more body. | chainAdd 1 | Every arc jumps to two more bodies. [chainAdd 2] | Every arc jumps to three more bodies. [chainAdd 3] | none |
...
| **Sniper Nest** | sniper_nest | passive | rare | damage core |  |  | Towers touching the Core face hit for half again. | coreAdjacentDamageMul 1.5 | same | Towers touching the Core face hit for double. [coreAdjacentDamageMul 2] | none |
...
| **Iron Sights** | iron_sights | passive | common | reach | yes |  | Every tower reaches one cell further. | mods [object Object] | Every tower reaches a cell and a half further. [mods [object Object]] | Every tower reaches two cells further. [mods [object Object]] | none |
...
| **Quick Hands** | quick_hands | passive | common | rate | yes |  | Every tower cycles two ticks faster. | mods [object Object] | Every tower cycles three ticks faster. [mods [object Object]] | Every tower cycles five ticks faster. [mods [object Object]] | none |
| **Deep Cold** | deep_cold | passive | common | cold |  |  | Every slow is 10% colder. | mods [object Object] | Every slow is 15% colder. [mods [object Object]] | Every slow is 25% colder. [mods [object Object]] | none |
| **Overclock** | overclock | passive | rare | energy |  |  | Every beam heats one multiple higher. | mods [object Object] | same | Every beam heats two multiples higher. [mods [object Object]] | none |
| **Wide Aura** | wide_aura | passive | rare | support |  |  | Every aura reaches one cell further. | mods [object Object] | same | Every aura reaches two cells further. [mods [object Object]] | none |
| **Rich Seam** | rich_seam | passive | common | economy |  |  | Every refinery mines one more Ore a cycle. | mods [object Object] | Every refinery mines two more Ore a cycle. [mods [object Object]] | Every refinery mines three more Ore a cycle. [mods [object Object]] | none |
...
| **Tempered Steel** | tempered_steel | passive | rare | damage reach |  |  | Every hit does 10% more and every tower reaches half a cell further. | damageMul 1.1, mods [object Object] | same | Every hit does 20% more and every tower reaches a cell further. [damageMul 1.2, mods [object Object]] | none |
| **Shield Breaker** | shield_breaker | passive | common | kinetic energy |  |  | Every hit does half again to shields. | mods [object Object] | Every hit does double to shields. [mods [object Object]] | Every hit does triple to shields. [mods [object Object]] | none |
