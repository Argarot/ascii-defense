...
|---|---|---|---|---|---|---|---|---|---|---|---|
| **Overflow** | overflow | passive | rare | damage |  |  | Overkill damage chains to the nearest enemy. Chain kills chain again. | overkillCarry true | same | same | none |
| **Frostbite** | frostbite | passive | common | cold | yes |  | Slowed enemies take +50% damage from everything. Stacks. | slowedDamageMul 1.5 | Slowed enemies take +75% from everything. [slowedDamageMul 1.75] | Slowed enemies take double from everything. [slowedDamageMul 2] | none |
| **Tithe** | tithe | passive | common | economy | yes |  | Every kill refunds 2 Scrap. Stacks. | killRefundScrap 2 | Every kill refunds 3 Scrap. [killRefundScrap 3] | Every kill refunds 5 Scrap. [killRefundScrap 5] | none |
| **Splinter** | splinter | passive | epic | damage |  |  | Explosions detonate twice: the same blast, resolved again a beat later - you will see both. | explodeTwice true | same | same | none |
| **Vein Tap** | vein_tap | passive | rare | core |  |  | You may build on rock. | buildOnRock true | same | same | none |
| **Loadbearing** | loadbearing | passive | epic | reach support |  |  | Towers touching the Core block get half again their range. | coreAdjacentRangeMul 1.5 | same | same | Towers touching the Core block get double range. [coreAdjacentRangeMul 2] |
| **Second Wind** | second_wind | passive | common | core |  |  | The Core mends 2 health every time a wave launches. | coreHealPerWave 2 | The Core mends 4 health every wave. [coreHealPerWave 4] | The Core mends 6 health every wave. [coreHealPerWave 6] | none |
| **Quarry** | quarry | passive | common | economy |  |  | Rock breaks three times faster - every prospect job, everywhere. | prospectSpeedMul 3 | Prospecting runs four times as fast. [prospectSpeedMul 4] | Prospecting runs six times as fast. [prospectSpeedMul 6] | none |
| **Toll** | toll | passive | common | economy | yes |  | Every enemy pays 1 Scrap for each cell it walks beside a tower. Stacks. | tollScrap 1 | Every enemy that passes a tower pays 2 Scrap. [tollScrap 2] | Every enemy that passes a tower pays 3 Scrap. [tollScrap 3] | none |
| **Bounty Board** | bounty_board | passive | common | economy |  |  | Bosses pay half again as much Scrap. | bossBountyMul 1.5 | Boss bounties pay double. [bossBountyMul 2] | Boss bounties pay triple. [bossBountyMul 3] | none |
...
| **Stasis Field** | stasis | active | common | cold | yes | 120 s | Freeze every enemy for 4 seconds. Towers keep firing. A second copy is a second charge. | freezeTicks 80 | Freeze every enemy for 6 seconds. Towers keep firing. [freezeTicks 120] | Freeze every enemy for 8 seconds. Towers keep firing. [freezeTicks 160] | none |
| **Deep Vein** | deep_vein | active | common | economy | yes | 120 s | Refineries produce five-fold for 20 seconds. A second copy is a second charge. | productionMul 5, boostTicks 400 | Refineries produce at six times for 30 seconds. [productionMul 6, boostTicks 600] | Refineries produce at eight times for 40 seconds. [productionMul 8, boostTicks 800] | none |
| **Sandbags** | sandbags | consumable | common | core | yes |  | Use: the Core gains 15 health, and 15 to its maximum. One use. | coreHpAdd 15 | The Core gains 25 max health, once. [coreHpAdd 25] | The Core gains 40 max health, once. [coreHpAdd 40] | none |
| **Flashbang** | flashbang | consumable | common | cold | yes |  | Use: every enemy freezes for 2 seconds. One use. | freezeTicks 40 | Freeze every enemy for 3 seconds, once. [freezeTicks 60] | Freeze every enemy for 4 seconds, once. [freezeTicks 80] | none |
| **Ore Pocket** | ore_pocket | consumable | common | economy | yes |  | Use: 20 Ore, right now. One use. | oreAdd 20 | 35 Ore, once. [oreAdd 35] | 60 Ore, once. [oreAdd 60] | none |
...
| **Cold Snap** | cold_snap | passive | common | cold |  |  | A slowed or frozen body that dies chills everything within a cell and a half for a second. | deathChillTicks 20 | ...for a second and a half. [deathChillTicks 30] | ...for two seconds. [deathChillTicks 40] | none |
| **Kindling** | kindling | passive | rare | energy damage |  |  | A burning body that dies passes its burn to everything within a cell and a half. Needs the Laser Lance in the run. | deathSpreadBurn true | same | same | none |
| **Salvage Rights** | salvage_rights | passive | common | economy |  |  | Sold towers refund 85% instead of 70%. | sellRefundBonus 0.15 | Sold towers refund in full. [sellRefundBonus 0.3] | Sold towers refund in full, and every build costs 10% less. [sellRefundBonus 0.3, buildCostMul 0.9] | none |
| **Bulk Order** | bulk_order | passive | common | economy | yes |  | Every tower costs 10% less. | buildCostMul 0.9 | Every tower costs 15% less. [buildCostMul 0.85] | Every tower costs 25% less. [buildCostMul 0.75] | none |
| **Cheap Upgrades** | cheap_upgrades | passive | common | economy | yes |  | Every tier choice costs 15% less. | tierCostMul 0.85 | Every tier choice costs 25% less. [tierCostMul 0.75] | Every tier choice costs 40% less. [tierCostMul 0.6] | none |
| **Wide Net** | wide_net | passive | common | kinetic | yes |  | Every plain shot passes into one more body (blasts never pierce). | pierceAdd 1 | Every shot passes into two more bodies. [pierceAdd 2] | Every shot passes into three more bodies. [pierceAdd 3] | none |
| **Grounding Rod** | grounding_rod | passive | common | energy | yes |  | Every arc jumps to one more body. Needs the Tesla Coil in the run. | chainAdd 1 | Every arc jumps to two more bodies. [chainAdd 2] | Every arc jumps to three more bodies. [chainAdd 3] | none |
| **Long Fuse** | long_fuse | passive | common | damage kinetic | yes |  | Every blast reaches half a cell further. | blastAdd 0.5 | Every blast reaches a cell further. [blastAdd 1] | Every blast reaches a cell and a half further. [blastAdd 1.5] | none |
| **Sniper Nest** | sniper_nest | passive | rare | damage core support |  |  | Towers touching the Core face hit for half again. | coreAdjacentDamageMul 1.5 | same | Towers touching the Core face hit for double. [coreAdjacentDamageMul 2] | none |
| **Bloodstone** | bloodstone | passive | common | core |  |  | Every tenth kill mends the Core by 1. | killHealEvery 10 | Every seventh kill mends the Core by 1. [killHealEvery 7] | Every fifth kill mends the Core by 1. [killHealEvery 5] | none |
| **Rush Bonus** | rush_bonus | passive | common | economy rate |  |  | Calling a wave early pays double the clock bonus. | callBonusMul 2 | Calling a wave early pays triple the clock bonus. [callBonusMul 3] | Calling a wave early pays four times the clock bonus. [callBonusMul 4] | none |
| **Scavenger** | scavenger | passive | common | economy |  |  | Caches pay double Scrap. | lootScrapMul 2 | Caches pay triple Scrap. [lootScrapMul 3] | Caches pay four times the Scrap. [lootScrapMul 4] | none |
| **Prospector's Eye** | prospectors_eye | passive | rare | economy |  |  | Prospecting rock costs nothing. | prospectFree true | same | same | none |
| **Iron Will** | iron_will | passive | common | core | yes |  | Every breach costs the Core 1 less. | breachReduce 1 | Every breach costs the Core 2 less. [breachReduce 2] | Every breach costs the Core 3 less. [breachReduce 3] | none |
| **Frost Nova** | frost_nova | active | common | cold | yes | 60 s | Every enemy on the board moves at half speed for 4 seconds. Recharges in a minute. | slowAllMul 0.5, slowAllTicks 80 | Every enemy moves at 40% for 6 seconds. [slowAllMul 0.4, slowAllTicks 120] | Every enemy moves at 30% for 8 seconds. [slowAllMul 0.3, slowAllTicks 160] | none |
| **Scrap Rain** | scrap_rain | consumable | common | economy | yes |  | 80 Scrap, once. | scrapAdd 80 | 140 Scrap, once. [scrapAdd 140] | 220 Scrap, once. [scrapAdd 220] | none |
| **Emergency Repair** | emergency_repair | consumable | common | core | yes |  | The Core mends 20 now. | coreHealNow 20 | The Core mends 35 now. [coreHealNow 35] | The Core mends 50 now. [coreHealNow 50] | none |
| **Foundry** | foundry | passive | rare | economy |  |  | A Refinery standing off any vein produces its yield as Scrap instead. The PRD's rule, broken by a relic. | refineryScrapOffVein true | same | same | none |
| **Thick Walls** | thick_walls | passive | common | core | yes |  | The Core holds 10 more while this is held. | coreHpMaxAdd 10 | The Core holds 20 more while this is held. [coreHpMaxAdd 20] | The Core holds 35 more while this is held. [coreHpMaxAdd 35] | none |
| **Iron Sights** | iron_sights | passive | common | reach | yes |  | Every tower reaches one cell further. | mods {range 1} | Every tower reaches a cell and a half further. [mods {range 1.5}] | Every tower reaches two cells further. [mods {range 2}] | none |
| **Hot Loads** | hot_loads | passive | common | damage | yes |  | Every hit does 15% more. | damageMul 1.15 | Every hit does 25% more. [damageMul 1.25] | Every hit does 40% more. [damageMul 1.4] | none |
| **Quick Hands** | quick_hands | passive | common | rate | yes |  | Every tower cycles two ticks faster. | mods {fireEveryTicks -2} | Every tower cycles three ticks faster. [mods {fireEveryTicks -3}] | Every tower cycles five ticks faster. [mods {fireEveryTicks -5}] | none |
| **Deep Cold** | deep_cold | passive | common | cold |  |  | Every slow is 10% colder. | mods {slowMul -0.1} | Every slow is 15% colder. [mods {slowMul -0.15}] | Every slow is 25% colder. [mods {slowMul -0.25}] | none |
| **Overclock** | overclock | passive | rare | energy |  |  | Every beam heats one multiple higher. Needs the Laser Lance in the run. | mods {beamRampMax 1} | same | Every beam heats two multiples higher. [mods {beamRampMax 2}] | none |
| **Wide Aura** | wide_aura | passive | rare | support |  |  | Every aura reaches one cell further. Needs the Bastion in the run. | mods {auraReach 1} | same | Every aura reaches two cells further. [mods {auraReach 2}] | none |
| **Rich Seam** | rich_seam | passive | common | economy |  |  | Every refinery mines one more Ore a cycle. | mods {production 1} | Every refinery mines two more Ore a cycle. [mods {production 2}] | Every refinery mines three more Ore a cycle. [mods {production 3}] | none |
| **War Chest** | war_chest | passive | common | economy | yes |  | Ten Scrap at every wave launch. | waveScrap 10 | Twenty Scrap at every wave launch. [waveScrap 20] | Thirty-five Scrap at every wave launch. [waveScrap 35] | none |
...
| **Payload** | payload | passive | common | damage | yes |  | A tower whose hit is under 10 hits for 10 more - before any multiplier. Nothing for a big gun. | damageAdd 10, damageAddBelow 10 | A tower whose hit is under 10 hits for 12 more - before any multiplier. [damageAdd 12, damageAddBelow 10] | A tower whose hit is under 10 hits for 15 more - before any multiplier. [damageAdd 15, damageAddBelow 10] | none |
...
| **Quarry Master** | quarry_master | active (fusion only) | epic | economy | yes | 90 s | Refineries produce at ten times for 40 seconds. Quarry and Deep Vein, fused. | productionMul 10, boostTicks 800 | same | same | Refineries produce at ten times for 80 seconds. [productionMul 10, boostTicks 1600] |
| **Doomsday** | doomsday | active (fusion only) | epic | damage cold | yes | 90 s | Strike anywhere: 900 damage in a 4-cell blast, and every enemy freezes for 2 seconds. Orbital Lance and Flashbang, fused. | orbitalDamage 900, orbitalRadius 4, freezeTicks 40 | same | same | Strike anywhere: 1500 damage in a 5-cell blast, and every enemy freezes for 3 seconds. [orbitalDamage 1500, orbitalRadius 5, freezeTicks 60] |
...
| **Superheated** | energy | 3 | Three of energy: every burning beam burns 1 a tick hotter. | burnDps 1 |  |
