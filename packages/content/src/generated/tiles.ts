  ...
  tiles: [
    {
      ...
      weight?: number;
      /**
       * A SPECIAL tile (2.21, extended 2026-08-19): selectable in the loadout, guaranteed on the map when chosen, never rolled from the random pools. Shipped tiles whose roads touch without merging, or carry two disconnected road segments, carry this flag. A special is FOR SALE when the meta tree lists it; its price is never written here - it is priceTile() over these cells and overlays (PRD sec 27, D31), the same function the Tile Smith mints with.
       */
      special?: boolean;
      /**
    ...
    "tiles": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "special": {
            "description": "A SPECIAL tile (2.21, extended 2026-08-19): selectable in the loadout, guaranteed on the map when chosen, never rolled from the random pools. Shipped tiles whose roads touch without merging, or carry two disconnected road segments, carry this flag. A special is FOR SALE when the meta tree lists it; its price is never written here - it is priceTile() over these cells and overlays (PRD sec 27, D31), the same function the Tile Smith mints with.",
            "type": "boolean"
          },
          "deposits": {
