...
export const THREAT_LEVELS: readonly ThreatLevel[] = [
  ...
  { name: 'Grim', entries: [3, 6], pathBias: 5, finalWave: 25, waveSeconds: 30, difficulty: { hpLinear: 0.15, hpGeometric: 1.10 /* INJECTED-REGRESSION: proving the balance gate goes red in CI; reverted in the next commit */, countBase: 6, countLinear: 5, countGeometric: 1, unlockDelay: 0, countMax: 60 }, walk: WALK.grim },
];
