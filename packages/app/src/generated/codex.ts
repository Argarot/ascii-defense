...
export const CODEX = {
  ...
  "relics": [
    ...
    },
    {
      ...
      "stacks": false,
      "recharge": "",
      "desc": "A burning body that dies passes its burn to everything within a cell and a half. Needs the Laser Lance in the run.",
      "rare": "",
      "epic": "",
      "legendary": "",
      "fusionOnly": false
    ...
    },
    {
      ...
      "stacks": true,
      "recharge": "",
      "desc": "Every arc jumps to one more body. Needs the Tesla Coil in the run.",
    ...
    },
    {
      ...
      "stacks": false,
      "recharge": "",
      "desc": "Every beam heats one multiple higher. Needs the Laser Lance in the run.",
      "rare": "",
    ...
    },
    {
      ...
      "stacks": false,
      "recharge": "",
      "desc": "Every aura reaches one cell further. Needs the Bastion in the run.",
      "rare": "",
