...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  ...
  { id: 'upgrade', target: 'upgrade', text: 'Scrap piles up - spend it. Select a tower and take a FORK in its card: an upgrade is a better buy than another tower, and one big hit gets through armour that a dozen small ones bounce off.', needsNext: false, done: (c) => c.upgrades >= 1 || c.wave >= 6 },
